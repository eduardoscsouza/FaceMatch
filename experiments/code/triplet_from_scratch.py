...
data_dir = "../../data/"
results_dir = "../results/triplet_from_scratch/"
tensorboard_dir = "../tensorboard_logs/triplet_from_scratch/"
...
for dist in ['eucl', 'cos']:
    ...
    if not os.path.isfile(os.path.join(aux_exp_dir, "metrics.csv")):
        ...
        vgg16_extractor = build_vgg16_triplet_extractor(vgg_weights_filepath=None, extraction_layer_indx=3)
